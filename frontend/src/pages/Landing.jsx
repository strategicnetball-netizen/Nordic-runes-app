...
function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between px-4 py-12 relative overflow-hidden" style={{ backgroundImage: 'url(/runes-landing.jpg)', backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundColor: '#0a0a14' }}>
      ...
      <div className="w-full relative z-10 flex justify-end pt-4 gap-4">
        <LanguageToggle />
        <button
          onClick={toggleMute}
      ...
      <div className="relative z-10 pb-8">
        <button
          ...
          className="bg-amber-700 hover:bg-amber-600 text-white font-bold py-3 px-8 rounded-lg transition text-lg"
          style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.5)' }}
        >
          {t('landing.cta')}
        </button>
